...
public class ToggleListener implements View.OnClickListener{
    ...
    public ToggleListener(int[] toggleButtonID, ToggleButton[] toggleButtons, Context context, Activity mActivity, MapView mapView, RelativeLayout infolayout) {
    ...
    public void onClick(View v) {
        ...
        if(ButtonOn) {
            ...
            if(mapView == null) {
                ...
                NetworkTask.getStoreDatas(mapView.getMapCenterPoint().getMapPointGeoCoord().latitude, mapView.getMapCenterPoint().getMapPointGeoCoord().longitude, cateGory,
                        new Callback() {
                            @Override
